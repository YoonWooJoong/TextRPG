...
namespace TextRPG
{
    internal class Program
    {
        ...
        // 아이템을 구조체로 사용할려고 했는데 list로 넣다보니 해당 변수들에 접근이 불가능 했습니다.
        // 그래서 어쩔수 없이 class로 만들어서 해결했습니다.
        // 찾아보니 구조체는 값형이라 값을 복사해서 원래 값에 영향이 없고 그래서 값을 변경하려고 하면 비주얼스튜디오에서 오류처리를 했습니다.
        // 그래서 결국 구조체는 포기하고 참조형인 class로 만들었습니다.

        // 여러 클래스를 사용하고 싶었는데 하다보니 결국 메서드 들로 구성되었습니다....
        // 클래스로 만드는 방법도 생각해야 할 것 같습니다.
